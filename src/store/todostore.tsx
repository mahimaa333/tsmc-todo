...
const TodoContextProvider: React.FC<ReactNode> = (props) => {
  ...
  const checkTodoHandler = async (code: string) => {
    ...
    const updateTodo = { ...targetTodo, complete: !targetTodo.completed };
    let updateTodos = [...todos];
    updateTodos[targetTodoIndex] = updateTodo;
    setTodos(updateTodos);
    await checkTodoAPI(code, !targetTodo.completed);
  };
